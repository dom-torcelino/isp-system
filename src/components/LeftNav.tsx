          ...
          >
            {collapsed ? (
              ...
              <div className="flex items-center justify-between w-full">
                <span className="text-m">Tenant Name</span>
        ...
        <TooltipProvider>
          <nav className={cn("space-y-1", collapsed ? "px-2" : "px-3")}>
            {navItems.map((item) => {
              ...
              const deniedReason = canAccess
                ? ""
                : getAccessDeniedReason(userRole, item.id);
              ...
              const navButton = (
                <button
                  ...
                  className={cn(
                    ...
                    collapsed
                      ? "gap-0 px-3 py-2.5 justify-center"
                      : "gap-3 px-3 py-2.5",
                    isActive
                    ...
                    isActive &&
                      collapsed &&
                      "before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-1 before:h-8 before:rounded-r-full before:bg-primary"
                  )}
                  disabled={!canAccess}
                >
                  <Icon
