...
const rbacChanges = [
  {
    time: "09:45 AM",
    actor: "admin@mail.com",
    change: "Role Updated",
    target: "maria.santos@mail.com",
    tenant: "FiberFast ISP",
    detail: "Support → SystemAdmin",
  },
  {
    time: "09:30 AM",
    actor: "admin@mail.com",
    change: "Permission Added",
    target: "jose.cruz@mail.com",
    tenant: "FiberFast ISP",
    detail: "billing:write",
  },
  {
    time: "09:15 AM",
    actor: "system",
    change: "User Created",
    target: "new.user@mail.com",
    tenant: "FiberFast ISP",
    detail: "Role: Support",
  },
  {
    time: "08:50 AM",
    actor: "admin@mail.com",
    change: "Permission Revoked",
    target: "old.user@mail.com",
    tenant: "FiberFast ISP",
    detail: "tenants:delete",
  },
];
...
const heatmapData = [
  {
    day: "Mon",
    hours: [
      2, 1, 0, 0, 1, 3, 8, 12, 15, 18, 14, 11, 9, 7, 12, 15, 10, 8, 5, 3, 2, 1,
      1, 1,
    ],
  },
  {
    day: "Tue",
    hours: [
      1, 0, 0, 1, 2, 4, 9, 14, 16, 20, 15, 12, 10, 8, 14, 16, 11, 9, 6, 4, 3, 2,
      1, 0,
    ],
  },
  {
    day: "Wed",
    hours: [
      1, 1, 0, 0, 1, 3, 7, 11, 14, 17, 13, 10, 8, 6, 11, 14, 9, 7, 4, 2, 1, 1,
      0, 1,
    ],
  },
  {
    day: "Thu",
    hours: [
      2, 0, 1, 0, 2, 5, 10, 15, 18, 22, 16, 13, 11, 9, 15, 18, 12, 10, 7, 5, 4,
      2, 1, 1,
    ],
  },
  {
    day: "Fri",
    hours: [
      1, 1, 0, 1, 1, 3, 6, 10, 13, 16, 12, 9, 7, 5, 10, 13, 8, 6, 3, 2, 1, 0, 0,
      0,
    ],
  },
  {
    day: "Sat",
    hours: [
      0, 0, 0, 0, 0, 1, 2, 3, 5, 7, 5, 4, 3, 2, 4, 5, 3, 2, 1, 0, 0, 0, 0, 0,
    ],
  },
  {
    day: "Sun",
    hours: [
      0, 0, 0, 0, 0, 0, 1, 2, 4, 6, 4, 3, 2, 1, 3, 4, 2, 1, 0, 0, 0, 0, 0, 0,
    ],
  },
];
...
const anomalies = [
  ...
  {
    title: "Sudden fail spike from ASN 64500",
    detail: "45 attempts in 5 minutes",
    severity: "high",
    icon: TrendingUp,
  },
  {
    title: "12 attempts from blocked country",
    detail: "Russia (RU)",
    severity: "medium",
    icon: Globe,
  },
  {
    title: "1 admin login outside business hours",
    detail: "02:30 AM login",
    severity: "low",
    icon: Clock,
  },
];
...
export function AuthSecurityView({ userRole }: AuthSecurityViewProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-4">
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <Select
            ...
            onValueChange={setSelectedMfaMethod}
          >
            <SelectTrigger className="w-[140px]">
      ...
      <div className="grid grid-cols-2 gap-6">
        <Card className="p-6">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Failed login attempts by hour and day
          </p>
              ...
              <div key={row.day} className="flex items-center gap-1">
                ...
                <div className="flex gap-0.5 flex-1">
                  {row.hours.map((value, idx) => (
                    <button
                      key={idx}
                      className={`h-6 flex-1 rounded-sm transition-all hover:ring-2 hover:ring-primary/50 ${getHeatmapColor(
                        value
                      )}`}
                      onClick={() => {
                        setSelectedHeatmapCell({ day: row.day, hour: idx });
                        toast.info(
                          `${row.day} ${idx}:00 - ${value} failed attempts`
                        );
                      }}
            ...
            {apiKeys.map((key, idx) => (
              <Card key={idx} className="p-3">
                ...
                <div className="flex items-center justify-between text-xs text-muted-foreground">
                  ...
                  <span
                    className={
                      key.rotatesIn === "Overdue" ? "text-error-500" : ""
                    }
                  >
      ...
      {/* Investigate Drawer */}
      <Sheet
        open={showInvestigateDrawer}
        onOpenChange={setShowInvestigateDrawer}
      >
