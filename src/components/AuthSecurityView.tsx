...
const authEvents = [
  ...
  { time: '10:30 AM', user: 'pedro.aquino@mail.com', role: 'SuperAdmin', provider: 'SSO', action: 'Login', result: 'Success', ip: '192.168.1.12', geo: 'Taguig, PH', device: 'Chrome / Windows', device: 'Chrome / Windows', risk: 'Medium' },
];
      ...
      <div className="grid grid-cols-6 gap-4">
        <Card className="p-4">
          <div className="flex items-start justify-between mb-2">
            ...
            <Sparkline data={[82, 83, 84, 85, 86, 87]} className="w-16 h-8" />
          </div>
        ...
        <Card className="p-4">
          <div className="flex items-start justify-between mb-2">
            ...
            <Sparkline data={[45, 38, 35, 32, 28, 23]} className="w-16 h-8" />
          </div>
          <div className="flex items-center gap-1 text-xs text-success-700">
        ...
        <Card className="p-4">
          <div className="flex items-start justify-between mb-2">
            ...
            <Sparkline data={[6, 5, 5, 4, 4, 4]} className="w-16 h-8" />
          </div>
        </Card>
        ...
        <Card className="p-4">
          <div className="flex items-start justify-between mb-2">
            ...
            <Sparkline data={[285, 295, 302, 308, 310, 312]} className="w-16 h-8" />
          </div>
        </Card>
        ...
        <Card className="p-4">
          <div className="flex items-start justify-between mb-2">
            ...
            <Sparkline data={[52, 54, 56, 58, 60, 61]} className="w-16 h-8" />
          </div>
        </Card>
        ...
        <Card className="p-4">
          <div className="flex items-start justify-between mb-2">
            ...
            <Sparkline data={[62, 60, 58, 56, 57, 58]} className="w-16 h-8" />
          </div>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        >
          <DonutChart
            ...
            height={280}
            showLegend
            centerLabel={`${mfaMethodData[0].name}\n${Math.round((mfaMethodData[0].value / mfaMethodData.reduce((a, b) => a + b.value, 0)) * 100)}%`}
          />
        </ChartCard>
      </div>
